...
const en = {
  ...
  portfolio: {
    ...
    contentNeeded: {
      category: "Project category needs to be added.",
      description: "Project description needs to be added.",
      screenshot: "Project screenshot needs to be added.",
      website: "Website URL needs to be added.",
    },
